...
var star, starimg
var star2
var stardis, emptystImg
var onestarimg, twostarsimg
...
function preload() {
  ...
  emptystImg = loadImage("empty.png")
...
function setup() {
  ...
  // STAR SPRITE
  star = createSprite(320, 50, 10, 10)
  ...
  //STAR DISPLAY
stardis = createSprite(95,60,20,20,)
stardis.addImage(emptystImg)
stardis.scale = 0.2
...
function draw() {
  ...
  if (collide(fruit,star) === true) {
    ...
    star.visible = false
    stardis.addImage(onestarimg)

  }

  if(collide(fruit,star2) == true){
star2.visible = false
stardis.addImage(twostarsimg)
  }
